            ...
            <div className='row container d-flex justify-content-center mt-3'>
                ...
                <div className='col-md-3'>
                    <div className='card'>
                        <img src={image3} alt="" />
                        <div className='card-body'>
                            <NavLink variant='primary' to = "/reportedepagos" className='nav-item nav-link text-center'>REPORTE DE PAGOS</NavLink>
                        </div>
                    </div>
                </div >
                <h1> </h1>
                <div className='col-md-4'>
                    <div className='card'>
                        <img src={image4} alt="" />
                        <div className='card-body'>
                            <NavLink variant='primary' to = "/reportedeseguimiento" className='nav-item nav-link text-center'>REPORTE DE SEGUIMIENTO</NavLink>
                        </div>
                    </div>
                </div >
            </div>
